...
extern BOOL process_touch_message( MSG *msg, UINT hw_id, const struct hardware_msg_data *msg_data );
extern BOOL process_gesture_message( MSG *msg, UINT hw_id, const struct hardware_msg_data *msg_data );
